    ...
    <div className="main-root">
      ...
      <div className="top-area">
        ...
        <div className="mid-controls">
          ...
          <div className="right-group">
            <button className="btn-fast" onClick={() => alert("빠른경로")}>▼ 빠른경로</button>
          </div>
        </div>
      </div>
      ...
      <div className="bottom-sheet">
        ...
        <div className="input-pill">
          ...
          <span className="input-val">신림역</span>
        </div>
        <div className="input-pill">
          <span className="input-label">도착지</span>
          <span className="input-val">논현역</span>
        </div>

        <div className="action-btns">
          <div className="btn-icon" role="button" tabIndex={0} onClick={() => alert("음성 조작 실행")}>
            <img className="icon-img" src="/assets/Mic.png" alt="음성" />
          </div>
          <div className="btn-icon" role="button" tabIndex={0} onClick={() => alert("검색 기능 실행")}>
